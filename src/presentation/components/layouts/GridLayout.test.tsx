...
describe('GridLayout Integration Tests', () => {
  ...
  describe('rendering with photos from context', () => {
    it('should render photos in grid layout', () => {
      ...
      renderWithProviders(
        <GridLayout photos={photos} onPhotoClick={onPhotoClick} loading={false} hasMore={false} />
      )
    ...
    it('should render grid items with correct structure', () => {
      ...
      renderWithProviders(<GridLayout photos={photos} loading={false} hasMore={false} />)
  ...
  describe('initial loading state', () => {
    it('should display skeleton loaders during initial load', () => {
      renderWithProviders(<GridLayout photos={[]} loading={true} hasMore={false} />)
    ...
    it('should not show photos during initial loading', () => {
      ...
      renderWithProviders(<GridLayout photos={photos} loading={true} hasMore={false} />)
  ...
  describe('loading more state', () => {
    ...
    it('should not show loading more when loadingMore is false', () => {
      ...
      renderWithProviders(
        <GridLayout photos={photos} loading={false} loadingMore={false} hasMore={true} />
      )
  ...
  describe('empty state', () => {
    it('should display empty state when no photos', () => {
      renderWithProviders(<GridLayout photos={[]} loading={false} hasMore={false} />)
  ...
  describe('error state', () => {
    it('should display error message when error is provided', () => {
      ...
      renderWithProviders(<GridLayout photos={[]} loading={false} error={error} hasMore={false} />)
    ...
    it('should not display photos when error exists', () => {
      ...
      renderWithProviders(<GridLayout photos={photos} loading={false} error={error} hasMore={false} />)
  ...
  describe('infinite scroll sentinel', () => {
    it('should render sentinel element when hasMore is true', () => {
      ...
      renderWithProviders(
        <GridLayout photos={photos} loading={false} loadMore={loadMore} hasMore={true} />
      )
    ...
    it('should not render sentinel when hasMore is false', () => {
      ...
      renderWithProviders(
        <GridLayout photos={photos} loading={false} loadMore={loadMore} hasMore={false} />
      )
