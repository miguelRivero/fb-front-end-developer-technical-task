...
export function ListLayout({
    ...
    return (
      <div className={styles.list}>
        {Array.from({ length: UI_CONSTANTS.SKELETON_COUNT }).map((_, index) => (
          <div key={index} className={styles.skeletonItem} data-testid="photo-skeleton">
  ...
  return (
    <>
      <div className={styles.list}>
        {photos.map((photo) => (
          <ListItem key={photo.id} photo={photo} onPhotoClick={onPhotoClick} />
        ))}
      </div>
        ...
        <div className={styles.loadingMore} data-testid="loading-more">
          <div className={styles.list}>
            {Array.from({ length: UI_CONSTANTS.LOADING_MORE_COUNT }).map((_, index) => (
              <div key={`loading-${index}`} className={styles.skeletonItem} data-testid="photo-skeleton">
                <div className={styles.skeletonThumbnail} />
                <div className={styles.skeletonContent}>
                  <div className={styles.skeletonLine} />
                  <div className={styles.skeletonLineShort} />
